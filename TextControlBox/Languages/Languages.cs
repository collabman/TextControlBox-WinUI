    ...
    public class SQL : SyntaxHighlightLanguage
    {
        public SQL()
        {
            ...
            this.Highlights = new SyntaxHighlights[]
            {
                ...
                //Functions
                new SyntaxHighlights("\\b(MIN|MAX|COUNT|SUM|AVG|ROW_NUMBER|IIF|CONCAT|UPPER|ISNULL|CAST|TRIM|LTRIM|RTRIM|SUBSTRING|LEN)\\b","#A970D5","#A970D5", false, false, false, true),
